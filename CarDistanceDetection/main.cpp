...
cv::CascadeClassifier people_cascade;
...
inline void face_detection(IplImage* image)
{
   ...
   face_cascade.detectMultiScale(mat_image, objects, 1.1, 2, 0 | CV_HAAR_SCALE_IMAGE, cv::Size(55, 55));
...
int main()
{
   // Absolute Paths for now
      ...
      people_cascade.load("C:\\opencv\\sources\\data\\haarcascades\\haarcascade_fullbody.xml");
      ...
      people_cascade.load("/Users/jarret/Projects/EyeTrackingSrc/haarcascades/haarcascade_mcs_upperbody.xml");
